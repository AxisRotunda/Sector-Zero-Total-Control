...
const ICONS = {
    ...
    MEDITATE: "M12 4a3 3 0 1 0-3 3 3 3 0 0 0 3-3m7 16h-3.8c-.8-2.6-2.5-4.4-4.8-5.1-.3-.1-.5-.2-.8-.2s-.5.1-.8.2c-2.3.7-4 2.5-4.8 5.1H3c0-3.3 2-6.2 5-7.4V12c0 2.2 1.8 4 4 4s4-1.8 4-4v-.7c3 1.2 5 4.1 5 7.4z",
